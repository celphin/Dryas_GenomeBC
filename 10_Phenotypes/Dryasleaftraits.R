...
for (trait in traits) {
  ...
  plot_filename <- paste0("./plots/", trait, ".png")

  # Save the plot to a PNG file
  png(plot_filename, width = 1000, height = 700)
  ...
  # Generate the filename for the plot
  plot_filename <- paste0("./plots/Treatment_", trait, ".png")
...
for (trait in traits) {
  ...
  # Generate the filename for the plot
  plot_filename <- paste0("./plots_seedlings/", trait, ".png")
  ...
  # Generate the filename for the plot
  plot_filename <- paste0("./plots_seedlings/Treatment_", trait, ".png")
