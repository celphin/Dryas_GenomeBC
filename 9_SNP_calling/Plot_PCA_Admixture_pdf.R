...
pdf("./plots/PCA_PC1_PC2_maf0.pdf")
All_samples_data %>%
...
All_samples_data$Site.x <- as.factor(All_samples_data$Site.x)
pdf("./plots/PCA_PC1_PC3_maf0.pdf")
All_samples_data %>%
...
pdf("./plots/PCA_PC1_PC2_maf0_W_C.pdf")
W_C_samples_data %>%
  ggplot(.,aes(x=PC1,y=PC2)) +
...
pdf("./plots/PCA_PC2_PC3_maf0_W_C.pdf")
W_C_samples_data %>%
...
pdf("./plots/PCA_PC3_PC4_maf0_W_C.pdf")
W_C_samples_data %>%
...
pdf("./plots/PCA_PC5_PC6_maf0_W_C.pdf")
W_C_samples_data %>%
...
pdf("./plots/PCA_PC1_W_C_diff.pdf")
...
pdf("./plots/PCA_PC3_W_C_diff.pdf")
...
pdf("./plots/PCA_PC1_W_C_treat.pdf")
...
pdf("./plots/PCA_PC3_W_C_treat.pdf")
...
pdf("./plots/PCA_PC1_PC3_maf0_W_C.pdf")
W_C_samples_data %>%
  ggplot(.,aes(x=PC1,y=PC3)) +
  geom_point(aes(color = Treatment.x), size=20)  +
  geom_text(aes(label = Site.x), color = "black", fontface = 2, size = 25.4/72.27*20)+
...
pdf("./plots/PCA_PC5_PC3_maf0_W_C.pdf")
W_C_samples_data %>%
...
pdf("./plots/Site_Admix_4_bar.pdf")
